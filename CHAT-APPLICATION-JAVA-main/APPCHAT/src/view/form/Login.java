...
public class Login extends JPanel{
	...
	public Login() {
		...
		panel = new JPanel();
		panel.setBounds(989, 174, 361, 500);
		...
		JButton but_Send = new JButton("New button");
		...
		but_Send.setBounds(72, 449, 85, 21);
		...
		btnLogin.setBounds(22, 352, 317, 19);
		panel_register.add(btnLogin);
		
		
		
		getOtp = new JTextField();
		getOtp.setBounds(215, 450, 96, 19);
